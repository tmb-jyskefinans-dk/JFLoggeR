...
import { settingsUnsavedChangesGuard } from './components/settings/settings-unsaved-changes.guard';
...
export const routes: Routes = [
  ...
  { path: 'settings', component: SettingsComponent, canDeactivate: [settingsUnsavedChangesGuard] }
];
